...
export default {
  ...
  home: {
    ...
    countSuffix: 'ta',
    addServiceBig: "Yangi xizmat qo'shish",
    searchPlaceholder: 'Xizmat qidirish: ism, tel, manzil, summa...',
    ...
    // Uchta katak (Xizmat | Xarajat | Daromad).
    monthOverview: 'Bu oy',
    vsPrev: "o'tgan oyning shu kunigacha nisbatan",
    paceService: 'Xizmat',
    paceExpense: 'Xarajat',
    paceIncome: 'Daromad',
    paceNew: 'yangi',
  ...
  services: {
    ...
    all: 'Barchasi',
    detail: 'Batafsil',
    // CHEKLANGAN AI paneli — FAQAT yangi qator qo'shadi (tahrir/o'chirish yo'q).
    aiAdd: 'AI qo\'shish',
    aiIntro: "Ovoz yoki matn yozing — men yangi xizmat qatorini qo'shaman. Masalan: \"Sardorga ertaga soat 18:00 da, Chilonzor, 200 ming\".",
    aiOnlyAdd: "Bu chat faqat YANGI xizmat qo'shadi — mavjud yozuvni o'zgartira/o'chira olmaydi.",
    aiPlaceholder: 'Masalan: Sardorga ertaga 18:00, 200 ming...',
    aiSaved: "Qo'shildi",
    aiNeedIdentity: "Yangi qator uchun kamida ism yoki telefon kerak oka.",
    aiMicError: "Mikrofonni ochib bo'lmadi — matn bilan yozing.",
    aiRec: 'Ovozli yozish',
    aiStopRec: 'To\'xtatish',
  },
