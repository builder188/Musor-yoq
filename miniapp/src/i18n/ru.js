...
export default {
  ...
  home: {
    ...
    countSuffix: 'шт',
    addServiceBig: 'Добавить услугу',
    searchPlaceholder: 'Поиск услуг: имя, тел, адрес, сумма...',
    todayJobs: 'Работы сегодня',
    balance: 'Баланс',
    noResults: 'Ничего не найдено',
    nextClientTitle: 'К кому ехать сейчас?',
    allDoneToday: 'Все дела на сегодня сделаны 🎉',
    monthSummary: 'Финансовый итог этого месяца',
    // Три плитки (Услуга | Расход | Доход).
    monthOverview: 'Этот месяц',
    vsPrev: 'к тому же дню прошлого месяца',
    paceService: 'Услуга',
    paceExpense: 'Расход',
    paceIncome: 'Доход',
    paceNew: 'новое',
  ...
  services: {
    ...
    all: 'Все',
    detail: 'Подробнее',
    // Ограниченная AI-панель — ТОЛЬКО добавляет новую строку (без редактирования/удаления).
    aiAdd: 'AI добавить',
    aiIntro: 'Напишите или продиктуйте — я добавлю новую строку услуги. Например: «Сардору завтра в 18:00, Чиланзар, 200 тысяч».',
    aiOnlyAdd: 'Этот чат только ДОБАВЛЯЕТ новую услугу — не может менять или удалять записи.',
    aiPlaceholder: 'Например: Сардору завтра 18:00, 200 тысяч...',
    aiSaved: 'Добавлено',
    aiNeedIdentity: 'Для новой строки нужно хотя бы имя или телефон.',
    aiMicError: 'Не удалось открыть микрофон — напишите текстом.',
    aiRec: 'Голосовой ввод',
    aiStopRec: 'Стоп',
